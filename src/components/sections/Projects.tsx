...
const projects: Project[] = [
  ...
  },
  {
    ...
    name: "MesaClick",
    nameES: "MesaClick",
    description: "SaaS for restaurant management with POS, kitchen display, QR digital menu and WhatsApp integration",
    descriptionES: "SaaS para gestión de restaurantes con punto de venta, pantalla de cocina, menú digital QR e integración con WhatsApp",
    image: "/images/projects/mesa.png",
    tech: ["Next.js", "React", "Tailwind", "Node.js", "PWA"],
    category: "real",
    demo: "https://mesaclick.vercel.app",
  },
  {
    id: "credired",
    name: "CrediRed",
    nameES: "CrediRed",
    description: "Software to manage credit sales and accounts receivable across a vendor network with multi-currency support",
    descriptionES: "Software para administrar ventas a crédito y cuentas por cobrar en red de vendedores con soporte multi-moneda",
    image: "/images/projects/credi.png",
    tech: ["Next.js", "React", "Tailwind", "Node.js"],
    category: "real",
    demo: "https://credi-red.vercel.app",
  },
  {
    id: "ventaclick",
    name: "VentaClick",
    nameES: "VentaClick",
    description: "SaaS for store management with product catalog, inventory control, multi-currency and WhatsApp catalog sharing",
    descriptionES: "SaaS para administrar tiendas con catálogo de productos, control de inventario, multi-moneda y catálogo compartible por WhatsApp",
    image: "/images/projects/venta.png",
    tech: ["Next.js", "React", "Tailwind", "Node.js", "PWA"],
    category: "real",
    demo: "https://ventaclick-xi.vercel.app",
  },
  {
    id: "paycopy",
    name: "PayCopy",
    nameES: "PayCopy",
    description: "App to share payment data organized in a link where the payer copies each detail with a single tap via Zelle",
    descriptionES: "App para compartir datos de pago organizados en un link donde el pagador copia cada dato con un solo toque vía Zelle",
    image: "/images/projects/paycopy.png",
    tech: ["Next.js", "React", "Tailwind", "PWA"],
    category: "real",
    demo: "https://paycopy.app",
  },
  {
    id: "trescaminos",
    name: "Tres Caminos Un Solo Dios",
    nameES: "Tres Caminos Un Solo Dios",
    description: "Landing page for the book 'Tres Caminos Un Solo Dios', a spiritual devotional available on Amazon",
    descriptionES: "Landing page del libro 'Tres Caminos Un Solo Dios', un devocional espiritual disponible en Amazon",
    image: "/images/projects/trescaminos.png",
    tech: ["Next.js", "React", "Tailwind"],
    category: "real",
    demo: "https://tres-caminos-landing.vercel.app",
  },
  {
    id: "netpartners",
    name: "NetPartners",
    nameES: "NetPartners",
    description: "Landing page for a tech partner company in Barcelona offering web development, apps and custom software",
    descriptionES: "Landing page de empresa socia tecnológica en Barcelona que ofrece desarrollo web, apps y software a medida",
    image: "/images/projects/netpartners.png",
    tech: ["Next.js", "React", "Tailwind"],
    category: "real",
