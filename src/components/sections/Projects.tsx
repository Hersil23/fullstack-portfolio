...
const projects: Project[] = [
  ...
  },
  {
    ...
    name: "HersilShop",
    nameES: "HersilShop",
    description: "E-commerce platform with inventory management and shopping cart",
    descriptionES: "Plataforma e-commerce con gestión de inventario y carrito de compras",
